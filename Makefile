...
warp:
	...
	cp src/boot/ksdk1.1.0/gfx/gfx.*                 build/ksdk1.1/work/demos/Warp/src/
	cp src/boot/ksdk1.1.0/gfx/cube.*                build/ksdk1.1/work/demos/Warp/src/
...
frdmkl03:
	...
	cp src/boot/ksdk1.1.0/devSSD1331.*				build/ksdk1.1/work/demos/Warp/src/
	cp src/boot/ksdk1.1.0/devINA219.*				build/ksdk1.1/work/demos/Warp/src/
	cd build/ksdk1.1/work/lib/ksdk_platform_lib/armgcc/KL03Z4 && ./clean.sh; ./build_debug.sh
	cd build/ksdk1.1/work/demos/Warp/armgcc/Warp && ./clean.sh; ./build_debug.sh
	@echo "\n\nNow, run\n\n\tmake load-warp\n\n"
